# Spec — google-oauth-setup (source of truth)
...
- **WHEN** se ejecuta la función SQL `crear_primer_admin(nombre, apellido, email)` con los datos del admin
...
#### Scenario: Navegación directa a ruta SPA
