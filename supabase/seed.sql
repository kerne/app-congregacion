...
INSERT INTO asignaciones_semana (semana, parte_id, asignado_id, asistente_id, tema, sala, congregacion_id) VALUES
  ...
  ('2026-04-13', 'lector_tesoros',       'a0000001-0000-0000-0000-000000000002', NULL,                                       NULL,                                           NULL,        'c0000001-0000-0000-0000-000000000001'),
  ...
  ('2026-04-13', 'mejores_maestros',     'a0000001-0000-0000-0000-000000000004', NULL,                                       'Cómo hacer preguntas que inviten a reflexionar',NULL,      'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-13', 'busqueda_tesoros',     'a0000001-0000-0000-0000-000000000005', NULL,                                       NULL,                                           NULL,        'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-13', 'smt_parte1',           'a0000001-0000-0000-0000-000000000006', 'a0000001-0000-0000-0000-000000000002',     'Primera visita',                               'principal', 'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-13', 'smt_parte2',           'a0000001-0000-0000-0000-000000000007', 'a0000001-0000-0000-0000-000000000003',     'Explicar las escrituras',                      'principal', 'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-13', 'nvc_parte1',           'a0000001-0000-0000-0000-000000000008', NULL,                                       'La oración como fuente de fortaleza',          NULL,        'c0000001-0000-0000-0000-000000000001'),
...
INSERT INTO asignaciones_semana (semana, parte_id, asignado_id, asistente_id, tema, sala, congregacion_id) VALUES
  ...
  ('2026-04-20', 'lector_tesoros',       'a0000001-0000-0000-0000-000000000003', NULL,                                       NULL,                                           NULL,        'c0000001-0000-0000-0000-000000000001'),
  ...
  ('2026-04-20', 'mejores_maestros',     'a0000001-0000-0000-0000-000000000005', NULL,                                       'Usa ilustraciones efectivas',                  NULL,        'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-20', 'busqueda_tesoros',     'a0000001-0000-0000-0000-000000000006', NULL,                                       NULL,                                           NULL,        'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-20', 'smt_parte1',           'a0000001-0000-0000-0000-000000000009', 'a0000001-0000-0000-0000-000000000004',     'Segunda visita',                               'principal', 'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-20', 'smt_parte2',           'a0000001-0000-0000-0000-000000000010', 'a0000001-0000-0000-0000-000000000005',     'Hacer discípulos',                             'principal', 'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-20', 'nvc_parte1',           'a0000001-0000-0000-0000-000000000011', NULL,                                       'Permaneced en el amor de Dios',                NULL,        'c0000001-0000-0000-0000-000000000001'),
...
INSERT INTO asignaciones_semana (semana, parte_id, asignado_id, asistente_id, tema, sala, congregacion_id) VALUES
  ...
  ('2026-04-27', 'lector_tesoros',       'a0000001-0000-0000-0000-000000000004', NULL,                                       NULL,                                           NULL,        'c0000001-0000-0000-0000-000000000001'),
  ...
  ('2026-04-27', 'mejores_maestros',     'a0000001-0000-0000-0000-000000000006', NULL,                                       'Adapta tu predicación a tu oyente',            NULL,        'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-27', 'busqueda_tesoros',     'a0000001-0000-0000-0000-000000000007', NULL,                                       NULL,                                           NULL,        'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-27', 'smt_parte1',           'a0000001-0000-0000-0000-000000000012', 'a0000001-0000-0000-0000-000000000006',     'Tercera visita',                               'principal', 'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-27', 'smt_parte2',           'a0000001-0000-0000-0000-000000000013', 'a0000001-0000-0000-0000-000000000007',     'Estudio bíblico en el ministerio',             'principal', 'c0000001-0000-0000-0000-000000000001'),
  ('2026-04-27', 'nvc_parte1',           'a0000001-0000-0000-0000-000000000014', NULL,                                       'Fortalece tu fe con la oración',               NULL,        'c0000001-0000-0000-0000-000000000001'),
...
INSERT INTO asignaciones_semana (semana, parte_id, asignado_id, asistente_id, tema, sala, congregacion_id) VALUES
  ...
  ('2026-05-04', 'lector_tesoros',       'a0000001-0000-0000-0000-000000000005', NULL,                                       NULL,                                           NULL,        'c0000001-0000-0000-0000-000000000001'),
  ...
  ('2026-05-04', 'mejores_maestros',     'a0000001-0000-0000-0000-000000000007', NULL,                                       'Sé organizado en tu predicación',              NULL,        'c0000001-0000-0000-0000-000000000001'),
  ('2026-05-04', 'busqueda_tesoros',     'a0000001-0000-0000-0000-000000000008', NULL,                                       NULL,                                           NULL,        'c0000001-0000-0000-0000-000000000001'),
  ('2026-05-04', 'smt_parte1',           'a0000001-0000-0000-0000-000000000015', 'a0000001-0000-0000-0000-000000000008',     'Cuarta visita',                                'principal', 'c0000001-0000-0000-0000-000000000001'),
  ('2026-05-04', 'smt_parte2',           'a0000001-0000-0000-0000-000000000004', 'a0000001-0000-0000-0000-000000000009',     'Ayudar a alguien a progresar',                 'principal', 'c0000001-0000-0000-0000-000000000001'),
  ('2026-05-04', 'nvc_parte1',           'a0000001-0000-0000-0000-000000000010', NULL,                                       'Cuida tu corazón con toda vigilancia',         NULL,        'c0000001-0000-0000-0000-000000000001'),
