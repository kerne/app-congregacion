...
export const PROGRAMA_FDS: ParteFDS[] = [
  { id: 'fds_presidente',         nombre: 'Presidente',              seccion: 'apertura', tieneTema: false, tieneAsistente: false, tieneOradorManual: false, cargosPermitidos: AM },
  { id: 'fds_orador',             nombre: 'Orador Discurso Público', seccion: 'discurso', tieneTema: true,  tieneAsistente: false, tieneOradorManual: true,  cargosPermitidos: AM },
  { id: 'fds_presidente_atalaya', nombre: 'Presidente Atalaya',      seccion: 'atalaya',  tieneTema: false, tieneAsistente: false, tieneOradorManual: false, cargosPermitidos: AM },
  { id: 'fds_lector_atalaya',     nombre: 'Lector Atalaya',          seccion: 'atalaya',  tieneTema: false, tieneAsistente: false, tieneOradorManual: false, cargosPermitidos: AM },
  { id: 'fds_oracion_final',      nombre: 'Oración Final',           seccion: 'cierre',   tieneTema: false, tieneAsistente: false, tieneOradorManual: false, cargosPermitidos: AM },
]
